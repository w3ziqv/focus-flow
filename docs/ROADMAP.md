...
| **v2.5.2** | Stage 5 | Completed | `v2.5.2` | Deep module architecture: Headless Timer Core, Consolidated Exporter, Unified Store, Audio Subsystem Facade |
| **v2.5.3** | Stage 5 | Completed | `v2.5.3` | Mobile zero-scroll Sanctuary, touch-friendly micro-step controls, unified command dock |
| **v2.6.0** | Stage 6 | **Current (Active)** | `v2.6.0` | Opt-in Google authentication, Firestore multi-device sync, conflict reconciliation |
